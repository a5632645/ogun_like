...
public:
    ...
    void SetCurrLineResolution(int resolution);
    int GetMaxLineResolution() const { return max_line_resolution_; }
    int GetCurrLineResolution() const { return curr_line_resolution_; }
    ...
    float GetNormalize(float nor) { return Get(curr_line_resolution_ * nor); }
...
private:
    int max_line_resolution_;
    int curr_line_resolution_;
